...
describe("baseline-scorer", () => {
  ...
  it("returns site-not-found fallback", async () => {
  ...
  it("high-severity panic_button gets high confidence and high tier", async () => {
    await execSql(`
  ...
  it("low-severity area_advisory gets low confidence and low tier", async () => {
    await execSql(`
  ...
  it("multiple distinct event types compound via noisy-OR", async () => {
    await execSql(`
  ...
  it("duplicate event types from same source do NOT compound", async () => {
    await execSql(`
  ...
  it("confidence is a valid probability in [0.01, 0.99]", async () => {
    await execSql(`
